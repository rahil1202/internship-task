...
5. Create a login simulator with username & password checks.

1. Write a program to check if a number is prime.
2. Count even and odd numbers between 1–100.
3. Create a multiplication table using `for`.
4. Use `switch` to print the day name for numbers (1–7).

---

## 🧩 Practice with HTML + CSS + JS

### 🖥️ 1. Grade Checker Tool

* HTML: Input for marks
* CSS: Style the box and result
* JS: Show `A/B/C/Fail` based on marks using `if...else if...else`

---

### 🖥️ 2. Number Checker App

* HTML: Input number + “Check” button
* JS: Check if the number is:

  * Even or odd
  * Positive or negative
  * Divisible by 5
* CSS: Use colors (green for positive, red for negative)

---

### 🖥️ 3. Day Finder

* HTML: Input number (1–7)
* JS: Use `switch` to print the day name.
* CSS: Nice card-style output.
